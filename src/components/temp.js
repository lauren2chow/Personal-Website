        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              <Nav.Link onClick={() => handleNavLinkClick('home')} className={activeLink === 'home' ? 'active navbar-link' : 'navbar-link'}>Home</Nav.Link>
              <Nav.Link onClick={() => handleNavLinkClick('skills')} className={activeLink === 'skills' ? 'active navbar-link' : 'navbar-link'}>Skills</Nav.Link>
              <Nav.Link onClick={() => handleNavLinkClick('projects')} className={activeLink === 'projects' ? 'active navbar-link' : 'navbar-link'}>Projects</Nav.Link>
              <Nav.Link onClick={() => handleNavLinkClick('portfolio')} className={activeLink === 'portfolio' ? 'active navbar-link' : 'navbar-link'}>Portfolio</Nav.Link>
              <Nav.Link onClick={() => handleNavLinkClick('education')} className={activeLink === 'education' ? 'active navbar-link' : 'navbar-link'}>Education</Nav.Link>
            </Nav>
